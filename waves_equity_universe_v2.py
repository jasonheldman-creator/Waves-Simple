...
def load_holdings_from_csv(url: str) -> pd.DataFrame:
    ...
    """
    # Streamlit Cloud can fetch HTTPS URLs fine.
...
def compute_wave_nav(wave_config, holdings: pd.DataFrame) -> dict:
    ...
    a consistent, non-crashing snapshot. So we return a flat NAV and N/A
    for returns/alpha. You can upgrade this later to use live prices.
    """
