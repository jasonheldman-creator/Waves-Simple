...
def enrich_snapshot_with_vix(
    ...
    """
    Adds VIX_Level and VIX_Regime columns if possible.
    Safe no-op if data is unavailable.
    """
...
def enrich_snapshot_with_strategy(
    ...
    """
    Adds strategy_stack and strategy_state columns.
    ...
    for idx, row in df.iterrows():
        ...
        if wave_id not in strategy_lookup:
            continue
