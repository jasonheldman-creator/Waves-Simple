        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-lg border border-gray-800 bg-gray-900/50 p-8 sm:p-12">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-white sm:text-3xl">Console Access</h2>
              <p className="mt-4 text-lg text-gray-400">{siteContent.console.description}</p>
              <div className="mt-8 p-4 rounded-lg bg-gray-800/50 border border-gray-700">
                <p className="text-sm text-gray-400">
                  For early access, contact:{" "}
                  <span className="text-cyan-400 font-semibold">jasonheldman-creator</span>
                </p>
              </div>
