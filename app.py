#!/usr/bin/env python3
"""
WAVES Intelligence™ Institutional Console (Production)
Authoritative entry point for WAVES UI
"""
...
st.sidebar.markdown("**Institutional Console**")
...
st.sidebar.markdown("---")
st.sidebar.caption("WAVES Intelligence™ v17.1")
st.sidebar.caption("Governance-Ready Attribution & Analytics")
...
st.markdown("---")
st.caption("WAVES Intelligence™ Institutional Console v17.1 — Production")
st.caption("Governance-Ready Attribution • Vector Truth • Decision Intelligence")
