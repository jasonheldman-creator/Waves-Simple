# ============================================================================
# BOOT GUARD: Prevent Streamlit Cloud boot-looping and surface real errors
# ============================================================================
import streamlit as st
st.set_page_config(page_title="WAVES Intelligence™", layout="wide")
st.markdown("✅ **WAVES BOOT OK** — app.py loaded")
st.caption("If you see this and then it crashes, the crash is after initial import.")

# ============================================================================
# Wrap remaining imports and initialization in try-except
# ============================================================================
try:
    ...
    st.exception(e)
    st.caption("The Boot Guard caught this error. Check the traceback above for details.")
