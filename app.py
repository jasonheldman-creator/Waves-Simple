...
# ========================================================================
# OPERATOR CONTROLS (TEMPORARILY DISABLED)
# ========================================================================

st.sidebar.markdown("#### 🛠️ Operator Controls")
st.sidebar.info(
    "Operator controls are temporarily disabled while the console is being stabilized.\n\n"
    "This does **not** affect portfolio logic, analytics, or data loading."
)
